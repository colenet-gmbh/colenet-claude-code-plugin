# Codebase Design — the software design vocabulary & principles

The shared **software design** language for this project — the vocabulary and principles used wherever code is designed or restructured. Its current core is **deep modules** (below); this is also the home for the rest of our design language as it grows — coupling and cohesion, separation of concerns, and the like. When you reach for a design term, take it from here; if it isn't here yet and it earns its place, add it.
...
## Software design glossary (this skill's glossary)
...
- **Deepening a cluster given its dependencies** — see deep-modules-deepening.md: dependency categories, seam discipline, and replace-don't-layer testing.
