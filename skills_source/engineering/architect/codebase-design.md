...
- **Deepening a cluster given its dependencies** — see [deep-modules-deepening.md](deep-modules-deepening.md): dependency categories, seam discipline, and replace-don't-layer testing.
