...
- When a decision is hard to reverse, surprising without context, and the result of a real trade-off, record it as an ADR in the ADR-dir (see [adr-format.md](adr-format.md)); chapter 9 references the directory.
