...
| 08 | Crosscutting Concepts | the **domain model** lives here, plus recurring patterns |
...
| 12 | Glossary | the **ubiquitous language** / domain glossary |

## How it wires into the other aspects

- **Domain model** (from the domain-modeling aspect) → chapter 8, as `08-1_domain-model.md`.
- **Glossary** → chapter 12, as `12_glossary.md`.
...
- Seed the cheap early chapters during the interview (`/grill-with-docs`): §1 Goals, §2 Constraints, §12 Glossary.
