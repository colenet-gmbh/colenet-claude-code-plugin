...
Read the project's domain glossary (locate via `CONTEXT.md`) and any ADRs in the area you're touching first.
...
**Use CONTEXT.md vocabulary for the domain, and the deep-modules vocabulary for the architecture.** If `CONTEXT.md` defines "Order," talk about "the Order intake module" — not "the FooBarHandler," and not "the Order service."
