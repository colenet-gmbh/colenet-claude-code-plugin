---
name: ask-capd
description: Routes to the right capd skill and walks the capd spine from idea to built slice. Use when the user is unsure which capd skill fits, wants an overview of capd, or says "ask capd", "was kann capd", "welcher Skill", "wie fange ich an", "capd help", or "guide me".
---

Help the user find the right capd skill and move along the spine. Read where they are,
then recommend and offer the single next step.

## The spine — from idea to built slice
...
## Utility skills (anytime, off the spine)
...
- If they are mid-spine, name the next step rather than restarting.
